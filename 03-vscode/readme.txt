...
Extensions: Live Server Extension (Ritwick Dey) 

Select Lines - Ctrl + / to comment. 

! + Tab --> Generates the skeleton html
...
Ctrl + Space for help - Put the cursor within double quotes or curly braces and press Ctrl + Space
Ctrl + . for suggestion (fixes)
